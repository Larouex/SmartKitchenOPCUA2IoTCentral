...
async def main(argv):
    ...
    for current_argument, current_value in arguments:
      if current_argument in ("-h", "--help"):
        ...
        print("")
        print("    -m or --modeltype - OPTIONAL: Provision as collective Twin Pattern or by Device Pattern.")
        print("       USAGE: -m device")
        print("       DEFAULT: twin")
        print("")
        print("    -n or --numberofdevices - OPTIONAL: The value is used to enumerate and provision the device(s) count specificed.")
        print("       USAGE: -n 10")
        print("       DEFAULT: 1")
        print("------------------------------------------------------------------------------------------------------------------------------------------")
        return
