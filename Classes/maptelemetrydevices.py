...
class MapTelemetryDevices():
    ...
    def load_file(self):
        with open('maptelemetrydevices.json', 'r') as config_file:
    ...
    def update_file(self, data):
        self.data = data
        with open('maptelemetrydevices.json', 'w') as config_file:
            alerts = self.load_alerts() 
